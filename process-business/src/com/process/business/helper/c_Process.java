...
public interface c_Process extends Com4jObject {
   ...
   * @param pNombreArch Mandatory Holder<java.lang.String> parameter.
   * @param pExtArch Mandatory Holder<java.lang.String> parameter.
   * @param pDescripcion Mandatory Holder<java.lang.String> parameter.
   * @param pAnexar Mandatory Holder<Boolean> parameter.
   * @param pDelimitador Mandatory Holder<java.lang.String> parameter.
   * @param pConsulta Mandatory Holder<java.lang.String> parameter.
   * @param pCampoInd Mandatory Holder<java.lang.String> parameter.
   * @return  Returns a value of type int
   */
